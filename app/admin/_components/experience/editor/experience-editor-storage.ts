...
const IMAGE_BUCKET_NAME = "experience-item-images";
...
export async function uploadExperienceImages(files: File[]) {
  ...
  return Promise.all(
    files.map(async (file) => {
      ...
      const objectPath = `items/${createClientId()}.${safeExtension}`;

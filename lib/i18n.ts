...
export const commonMessages = {
  ...
  preparingModal: {
    ko: {
      ...
      infoLabel: "안내 말씀",
      bodyPrefix: "NORA STAY가 새로운 여정을, ",
      bodySuffix:
        "에서 인사드릴 예정입니다. 완성도 있게 준비 중이니 많은 기대 부탁드립니다.",
      confirm: "확인",
    },
    en: {
      ...
      infoLabel: "Notice",
      bodyPrefix: "NORA STAY is preparing a new stay experience at ",
      bodySuffix: ". We are getting everything ready and look forward to welcoming you soon.",
      confirm: "Close",
    },
  },
  popup: {
